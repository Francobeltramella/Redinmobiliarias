...
$municipio=$con->real_escape_string(htmlentities($_POST['municipio']));
$callenum=$con->real_escape_string(htmlentities($_POST['callenum']));
$_SESSION['id']=$_POST['id'];


if (empty($nick)  || empty($pass1) || empty($nombre)  || empty($matricula) ){
...
$pass1=sha1($pass1);
$ins =$con->query("INSERT INTO usuario VALUES ('', '$nick','$matricula', '$pass1', '$nombre','$correo','$telefono','$nivel', 1, '$ruta','$estado','$municipio','$callenum')");
if ($ins) {
  header('location:../extend/alert.php?msj=Gracias por registrarse, su usuario estara habilitado en los proximos minutos&c=salir&p=in&t=success');

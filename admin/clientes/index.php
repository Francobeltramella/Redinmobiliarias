...
if($_SESSION['nivel']=='ADMINISTRADOR'){
  $sel=$con->prepare("SELECT * FROM clientes WHERE usuario_id='$id'");
}else{
         ...
         <table>
           ...
           <?php while($f=$res->fetch_assoc()){ ?>
             <tr>
               ...
               <td> <a href="editar_cliente.php?id=<?php  echo $f['id']?>" class="btn-floating blue" title="Editar cliente"><i class="material-icons">loop</i></a> </td>
               <td>
                 <a href="# " title ="Eliminar cliente" class="btn-floating red" onclick="
                 swal({
                   ...
                   location.href='eliminar_cliente.php?id=<?php  echo $f['id'] ?>';

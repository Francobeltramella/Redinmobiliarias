        ...
        <form  action="ins_bd.php" method="post" autocomplete="off" >
           <div class="row">
             <div class="col-sm-12">
               ...
               <input type="text" name="nombre"   value="<?php echo $f['nombre'] ?>" id="nombre" readonly="readonly"   >


             </div>
             <div class="col-sm-12">
               <label for="apellido">Apellido</label>
               <input type="text" name="apellido" value="<?php echo $f['apellido'] ?>" readonly="readonly"   id="apellido"  >


             </div>
             <div class="col-sm-12">
               <label for="dni">DNI</label>
               <input type="number" name="dni"  value="<?php echo $f['dni'] ?>" readonly="readonly"  id="dni"   >
...
<div class="input-field col s6">
  ...
  <div class="input-field col s6">
    ...
    <div class="input-field col s12">
      ...
      <input type="hidden" name="iddato" id="iddato" value="<?php echo $id?>" >
    </div>

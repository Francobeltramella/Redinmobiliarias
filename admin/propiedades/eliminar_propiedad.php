...
if($del->execute()){
  ...
  $del_img->execute();
  $del_img->close();
    header('location:../extend/alert.php?msj=Propiedad eliminada&c=prop&p=can&t=success');
}else{
    header('location:../extend/alert.php?msj=Propiedad no eliminada&c=prop&p=can&t=error');
}

...
if($ins){
    header('location:../extend/alert.php?msj=Imagenes guardadas&c=prop&p=img&t=success&id='.$id.'');
}else{
    header('location:../extend/alert.php?msj=Imagenes no guardadas&c=prop&p=img&t=error&id='.$id.'');
}

<?php include '../extend/header.php';
  ...
  $sel = $con->prepare("SELECT propiedad ,
    consecutivo,nombre_cliente,calle_num,fraccionamiento,estado,municipio,precio,forma_pago,asesor,tipo_inmueble,operacion,mapa,foto_principal
    FROM inventario WHERE estatus ='CANCELADO' ");
      ...
      <div class="card-content">
        ...
        <table>
          ...
          while ($f =$res->fetch_assoc()) {?>
            <tr>
              <td><button data-target="modal1" onclick="enviar(this.value)"  class="btn-floating" value="<?php echo $f['propiedad'] ?>" class="btn modal-trigger"> <i class="material-icons">visibility</i> </button></td>
              ...
              <td><a href="# " class="btn-floating red" onclick="
              swal({
                ...
                location.href='eliminar_propiedad.php?id=<?php  echo $f['propiedad'] ?>&foto=<?php echo $f['foto_principal'] ?>';

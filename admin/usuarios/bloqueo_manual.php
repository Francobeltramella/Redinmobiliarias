...
if($bloqueo ==1){
  ...
  if($up){
    header('location:../extend/alert.php?msj=El usuario ha sido bloqueado&c=us&p=in&t=success');

  }else{
      header('location:../extend/alert.php?msj=El usuario no ha podido ser bloqueado&c=us&p=in&t=error');
}
  }else{

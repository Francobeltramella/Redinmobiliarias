...
<form class="form" action="ins_usuarios.php" method="post" enctype="multipart/form-data">
  <div class="input-field">
    <input type="text" name="nick" required autofocus title="DEBE CONTENER ENTRE 8 Y 15 CARACTERES, SOLO LETRAS" pattern="[A-Za-z]{8,15}"
...
<label for="nick">Nick</label>
    ...
    <div class="input-field">
      <input type="password" name="pass1" title="CONTRASEÑA CON NUMEROS, LETRAS MAYUSCULAS Y MINUSCULAS"
      pattern="[A-Za-z0-9]{8,15}" id="pass1" required>
      <label for="pass1"> Contraseña</label>
    </div>
    <div class="input-field">
      <input type="password"  title="CONTRASEÑA CON NUMEROS, LETRAS MAYUSCULAS Y MINUSCULAS"
      pattern="[A-Za-z0-9]{8,15}" id="pass2" required>
      <label for="pass2"> Verificar contraseña</label>
    </div>

    <select class="nivel" name="nivel" required>
          ...
          <table>
            ...
            <?php while($f =$sel->fetch_assoc()){ ?>
              <tr>
                ...
                <td><img src="<?php echo $f['foto'] ?>" width="200" height="200">   </td>
                <td>
                  <?php if($f['bloqueo']==1): ?>
                ...
                swal({
                  ...
                  location.href='eliminar_usuario.php?id=<?php  echo $f['id'] ?>';

   ...
   <div class="container mt-5 pt-5">
     <div class="row">
       <div class="col-md-6 my-5 text-lg-left text-center align-self-center">
         <h1 class="display-4 mb-2">ALQUILER <br><br> </h1>
         <p class="lead"></p>
       ...
       <div class="col-md-6 mt-5 ">
         <form class="form-group " action="buscarlocalidadalqui.php" method="post">
           <div class="form-group"><label>
             <b><b>Localidad</b></b></label>
             <input name="municipio"   list="ciudades" value="" class="form-control" id="inlineFormInputGroup" placeholder=" Buscar por localidad"></div>
   ...
   <div class="container">
     <div class="row">
       <div class="col-12 text-center">
         <h2 class="pb-4"><b><b>ALQUILERES  </b> </b> </h2>
         <?php
         include 'admin/conexion/conexion.php';
          ?>
         ...
         <div class="row" style=" margin-right: 0px;">
           <?php
             $sel_marc=$con->prepare("SELECT foto_principal,precio,estado,municipio,fraccionamiento,propiedad,banos ,recamaras,cocheras,operacion,moneda ,tipo_inmueble,calle_num,vendido,alquilado,nick_id FROM inventario WHERE marcado='SI' AND operacion='ALQUILER' ORDER BY rand(marcado='SI')");
             $sel_marc->execute();
